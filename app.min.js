      ...
      , d = {
        ...
        renderSVG: function(b) {
            ...
            a.each(c[b].area, function(g, h) {
                ...
                i && (i.attr("class", "image-mapper-shape"),
...
<head>
  ...
  <!-- APPLE APP -->
  <meta name="apple-mobile-web-app-title" content="สร้างแอป">
  ...
  <!--  FAVICON -->
  <link rel="icon" type="image/jpg" sizes="96x96" href="./img/logo.png">
  <link rel="icon" type="image/jpg" sizes="32x32" href="./img/logo.png">
  <link rel="icon" type="image/jpg" sizes="16x16" href="./img/logo.png">
  <link rel="shortcut icon" type="image/x-icon" href="./img/logo.png">
  <link rel="icon" type="image/x-icon" href="./img/logo.png">

</head>
<body>
<!--โค๊ดนี้สร้างโดย ครบเครื่อง เรื่องไอที -->`;
            return h + "\n" + d[0].outerHTML + "\n\n" + f[0].outerHTML +" </body> </html>"
        }
    };
...
function(a) {
    a(document).on("init", function() {
        ...
        a(document).on("change focus", "#image-mapper-url", function() {
